  ...
  return (
    <Card className="bg-[#FFFFFF] shadow-lg rounded-xl">
      <CardHeader className="pb-2">
        <CardTitle className="text-2xl font-bold text-[#202020] flex items-center gap-3 tracking-tight">
          <Users className="w-6 h-6 text-[#202020]" /> Target Audience
          <span className="ml-auto px-4 py-1 rounded-full bg-[#CFD2D4] text-[#202020] font-medium text-xs border border-[#202020]/10">
              ...
              <div className="grid grid-cols-1 gap-3 mt-3">
                ...
                {client.segment?.growth && (
                  <div className="flex items-center gap-1 text-[#202020] font-medium">
                    <TrendingUp className="w-3 h-3 text-[#202020]" />
