...
const RevenueModelCard = ({ revenueModel, currency }: RevenueModelCardProps) => {
  ...
  return (
    <>
      <Card className="border-none outline-none shadow-none" style={{ background: '#F4EFEC' }}>
        <CardHeader>
      ...
      {/* Financial Projections and the rest in a new Card */}
      <Card className="border-none outline-none shadow-none" style={{ background: '#F8F7F3' }}>
        <CardContent className="space-y-8 p-6">
