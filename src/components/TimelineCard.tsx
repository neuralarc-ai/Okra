  ...
  return (
    <div>
      <CardHeader className="pb-2">
        <CardTitle className="text-xl font-medium flex items-center gap-2 text-[#202020]">
      ...
      <CardContent className="p-6">
        <div className="space-y-6">
          {/* Total Duration */}
          <div className="flex items-center justify-between px-4 py-3 rounded-xl border border-[#202020]/10 mb-2">
          ...
          <div className="space-y-4">
            {timeline.phases.map((phase, index) => (
              <div
                key={index}
                className="p-5 border border-[#202020]/10 rounded-xl transition-all duration-200 hover:border-blue-400/30 hover:bg-blue-400/5 shadow-sm"
              >
                {/* Phase header */}
