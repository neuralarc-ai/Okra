    ...
    <Card className="card-bg hover-card shadow-lg overflow-y-auto hide-scrollbar">
      ...
      <CardContent>
        ...
        <section className="mb-8">
          <h3 className="text-lg font-semibold text-white mb-3 tracking-wide">Key Metrics</h3>
        ...
        <section className="mb-8 p-6 bg-white/5 rounded-xl border border-white/10">
          <h3 className="text-lg font-semibold text-white mb-2 tracking-wide">Executive Summary</h3>
          <p className="text-base text-white leading-relaxed">{scoreAnalysis.executiveSummary}</p>
        </section>

        {/* Detailed Analysis */}
        <section className="mb-8">
          <h3 className="text-lg font-semibold text-white mb-3 tracking-wide">Detailed Analysis</h3>
          ...
          {/* Recommendations */}
          <div className="p-4 border border-green-500/20 bg-green-500/5 rounded-xl mb-4">
            <div className="text-base font-semibold text-green-300 mb-2 flex items-center gap-2"><Sparkles className="h-4 w-4" /> Key Recommendations</div>
